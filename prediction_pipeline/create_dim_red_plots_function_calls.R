...
#tra with combat and prot with combat re-executing to get boxplots without background
...
create_dim_red_plots(comparison = "CFRDVsIGT",
                     ...
                     omics_type = "prot",
                     box_plot_dir_path = "plots_updated/boxplots_prot",
                     biomarker_expr_file_path = "data/selected_features/prot_combat_biomarkers.xlsx")
create_dim_red_plots(comparison = "CFRDVsNGT",
                     classes = c("CFRD", "NGT"), class_colours = c("red", "yellow"),
                     dim_red = "UMAP",
                     norm = "quantile",
