...
create_dim_red_plots(comparison = NA,
                     ...
                     phenotype = phenotype %>% dplyr::rename("disease_status" = "condition") %>% dplyr::rename("condition" = "modstatus_condition"),
                     filter_post_modulator = FALSE,
                     custom_title = "Transcriptomics shift from CFRD to NGT with Log CPM norm and ComBat two_in_one_shot with median", 
...
create_dim_red_plots(comparison = NA,
                     ...
                     phenotype = phenotype %>% dplyr::rename("disease_status" = "condition") %>% dplyr::rename("condition" = "modstatus_condition"),
                     filter_post_modulator = FALSE,
                     custom_title = "Transcriptomics pre and post modulator with with Log CPM norm and ComBat two_in_one_shot", 
                     combat = FALSE, simplified = TRUE)
create_dim_red_plots(comparison = NA,
                     classes = c("PreModulator_CFRD", "PostModulator_CFRD", 
                                 "PreModulator_NGT", "PostModulator_NGT",
                     ...
                     phenotype = phenotype %>% dplyr::rename("disease_status" = "condition") %>% dplyr::rename("condition" = "modstatus_condition"),
                     filter_post_modulator = FALSE,
                     custom_title = "Transcriptomics pre and post modulator with Log CPM norm and ComBat two_in_one_shot with mean", 
                     combat = FALSE, simplified_with_mean = TRUE)
create_dim_red_plots(comparison = NA,
                     classes = c("PreModulator_CFRD", "PostModulator_CFRD", 
                                 "PreModulator_NGT", "PostModulator_NGT",
                     ...
                     phenotype = phenotype %>% dplyr::rename("disease_status" = "condition") %>% dplyr::rename("condition" = "modstatus_condition"),
                     filter_post_modulator = FALSE,
                     custom_title = "Transcriptomics pre and post modulator with Log CPM norm and ComBat two_in_one_shot with median", 
                     combat = FALSE, simplified_with_mean = TRUE)
