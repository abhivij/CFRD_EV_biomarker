...
create_dim_red_plots(comparison = NA,
                     ...
                     dim_red = "UMAP",
                     norm = "non-normalized",
                     dir_path = "plots_updated/post_mod/proteomics/shift/2025May",
                     dimred_plot_width_cm = 57,
                     perform_filter = FALSE,
                     colour_column = "batch_name", point_border_colours = c("black", "green", "purple"),
                     data = data,
                     phenotype = phenotype %>% dplyr::rename("disease_status" = "condition") %>% dplyr::rename("condition" = "modstatus_condition"),
                     filter_post_modulator = FALSE,
                     custom_title = "Proteomics pre and post modulator with Quantile norm and ComBat two_in_one_shot smaller", 
                     combat = FALSE, simplified = TRUE)
...
create_dim_red_plots(comparison = NA,
                     ...
                     phenotype = phenotype %>% dplyr::rename("disease_status" = "condition") %>% dplyr::rename("condition" = "modstatus_condition"),
                     filter_post_modulator = FALSE,
                     custom_title = "Proteomics PostIGT, PostNGT, PreCFRD with Quantile norm and ComBat two_in_one_shot", 
                     combat = FALSE, simplified = TRUE)
